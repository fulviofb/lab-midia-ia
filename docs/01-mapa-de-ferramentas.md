...
2. O guia atual `docs/guias/06-ideia-roteiro-cenas-video.md` — caminho até o render.
3. `workflows/roteiro-curto-antes-de-produzir.md` — opcional, só quando houver história.
